...
async function getAllTodos(req,res){
    var todos = await TodoModel.find({  user: req.user._id })
...
async function getTodoById(req,res){
  ...
  var todo = await TodoModel.findById({_id: id, user: req.user._id})
...
async function deleteTodos(req,res){
  ...
  // now update the data
  await TodoModel.findByIdAndDelete({_id: id,  user: req.user._id  })
